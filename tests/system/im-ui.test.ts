...
describe("全局 IM 工作区界面", () => {
  ...
  it("提供全局入口、三栏工作区、模型设置和 typed mention composer", async () => {
    ...
    expect(page.text).toContain("feature=global-im-v47");
    ...
    expect(application.text).toContain('/im.js?v=20260901-global-im-v47');
    ...
    expect(im.text).toContain('opened && current ? openConversation(current.id) : refreshConversations()');
