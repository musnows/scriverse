...
describe("S3 backup settings UI", () => {
  it("serves system settings, accessible controls, and versioned assets", async () => {
    ...
    const module = await request(runtime.app).get("/s3-backup-ui.js?v=20260905-s3-backup-v1").expect(200);
    ...
    expect(html.text).toContain('/app.js?v=20260905-s3-backup-v1');
    expect(html.text).toContain('/styles.css?v=20260905-s3-backup-v1');
