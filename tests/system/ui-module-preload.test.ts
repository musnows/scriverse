...
describe("工作台模块图预加载", () => {
  ...
  it("在首屏 head 中并行发现入口和全部直接依赖", async () => {
    ...
    expect(preloadHrefs).toHaveLength(62);
    ...
    expect(preloadHrefs).toContain("/ai-interactive.js?v=20260829-question-supplement-v4");
    expect(preloadHrefs).toContain("/chapter-line-id-tracker.js?v=20260828-stable-line-ids-v1");
