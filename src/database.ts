...
export class Database {
  ...
  private applyDataMigrations(): void {
    ...
    if (!applied.has(125) || !workMcpSettingsPresent) {
      this.transaction(() => {
