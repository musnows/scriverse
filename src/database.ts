...
export class Database {
  ...
  private applyDataMigrations(): void {
    ...
    if (!applied.has(127) || !aiQuestionColumns.has("questions_json") || !aiQuestionColumns.has("answers_json")) {
      this.transaction(() => {
