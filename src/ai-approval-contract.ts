...
export const approvalEntitySchemas = {
  ...
  "character-section": z.object({ title: name, sectionType: z.string().max(100).optional(), contentMarkdown: text.optional(), summary: z.string().max(5000).optional(), sortOrder: z.number().int().min(0).max(10000).optional() }).strict(),
